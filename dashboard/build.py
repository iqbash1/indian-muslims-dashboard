...
NARRATIVE_CSS = """
  ...
  .card-narrative .cn-toggle > summary::before, .landing-narrative .cn-toggle > summary::before { content: "▸"; font-size: 13px; line-height: 1; transition: transform .15s; }
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .method-more > summary::before { content: "▸"; font-size: 13px; line-height: 1; transition: transform .15s; }
  ...
  @media (hover: none) and (pointer: coarse) {
    ...
    .cn-sh-donate { min-height: 44px; padding: 6px 16px; }
...
PLAIN_DEFINITION = {
    ...
    "mla-share": "Across all 31 state and UT legislative assemblies that hold elections, what share of MLA seats is held by Muslims. Each state pairs two bars: the maroon share of assembly seats against the grey share of population (Census 2011), so each state's seats can be compared at a glance with its share of the population.",
